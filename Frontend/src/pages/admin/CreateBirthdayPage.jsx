...
const CreateBirthdayPage = () => {
  const {
    ...
    handleSubmit, copyUrl, currentTemplates, API_BASE,
  } = useInvitationForm("birthday");
    ...
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-[var(--color-text)]">
          {isEditMode ? "Edit Birthday Invitation" : "Create Birthday Invitation"}
        </h2>
        <p className="text-sm text-[var(--color-text-muted)] mt-1">Design a fun and memorable birthday invitation card</p>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className={cardCls}>
              ...
              <div>
                ...
                <input name="cardId" value={form.cardId} onChange={handleChange} disabled={isEditMode} placeholder="e.g. alex-turning-30" required className={`${inputCls} disabled:opacity-50`} />
              </div>
              <div>
            ...
            <div className={cardCls}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input name="celebrantName" value={form.celebrantName} onChange={handleChange} required placeholder="e.g. Alex Johnson" className={inputCls} />
                </div>
                <div>
                  <label className={labelCls}>Age / Turning</label>
                  <input type="number" name="age" value={form.age} onChange={handleChange} placeholder="e.g. 30" className={inputCls} />
                </div>
              </div>
            </div>
            ...
            <div className={cardCls}>
              ...
              <textarea name="welcomeText" value={form.welcomeText} onChange={handleChange} rows={3} placeholder="e.g. Come celebrate with us!" className="w-full px-4 py-3 text-sm bg-[var(--color-surface-50)] border border-[var(--color-border)] rounded-[var(--radius-md)] text-[var(--color-text)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20 focus:border-[var(--color-primary)]/50 transition-all resize-none" />
            </div>
          </div>
            ...
            <div className={cardCls}>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <input name="eventLocation" value={form.eventLocation} onChange={handleChange} required placeholder="e.g. The Grand Ballroom, Colombo" className={inputCls} />
                </div>
                <div className="col-span-2">
